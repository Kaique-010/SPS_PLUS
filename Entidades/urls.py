...
from .views import EntidadeDeleteView, EntidadeUpdateView,exportar_entidades
...
urlpatterns = [
    ...
    path('entidade/delete/<str:enti_clie>/', EntidadeDeleteView.as_view(), name='entidade_delete'),
